...
//DOCUMENTATION
	docOverview: {
		...
		description: 'documentation for spm, style package manager and registry',
	...
	docCheatSheet: {
		...
		description: 'cheat sheet for spm, style package manager and registry',
	...
	docCLIRunThrough: {
		...
		description: 'CLI run through for spm, style package manager and registry',
	...
	docGenerate: {
		...
		description: 'generate for spm, style package manager and registry',
	...
	docGettingStarted: {
		...
		description: 'getting started for spm, style package manager and registry',
	...
	docInit: {
		...
		description: 'init for spm, style package manager and registry',
	...
	docInstall: {
		...
		description: 'install for spm, style package manager and registry',
	...
	docPublish: {
		...
		description: 'publish for spm, style package manager and registry',
	...
	docUse: {
		...
		description: 'use for spm, style package manager and registry',
	...
	docWhatIsSpm: {
		...
		description: 'what is spm, style package manager and registry',
...
//CONNECTION
	signIn: {
		...
		description: 'sign in for spm, style package manager and registry',
	...
	signUp: {
		...
		description: 'sign up for spm, style package manager and registry',
...
//PACKAGES
	packagesOverview: {
		...
		description: 'packages for spm, style package manager and registry',
	...
	contact: {
		...
		description: 'contact for spm, style package manager and registry',
...
//POLICIES
	policiesTerms: {
		...
		description: 'terms for spm, style package manager and registry',
	...
	policiesPrivacy: {
		...
		description: 'privacy policy for spm, style package manager and registry',
	...
	policiesConduct: {
		...
		description: 'code of conduct for spm, style package manager and registry',
